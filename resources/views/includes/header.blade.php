    ...
    <div class="container">
        ...
        <div class="row row2">
            <div class="col-sm-2">
                ...
                <h1 href="/"style="margin:0px;"><span class="largenav">Okaeri-Shop</span></h1>
            </div>
            <div class="flipkart-navbar-search smallsearch col-sm-8 col-xs-11">
                <div class="row">
                    <input class="flipkart-navbar-input col-xs-11" type="" placeholder="Buscar..." name="">
            ...
            <div class="cart largenav col-sm-2">
                <a class="cart-button" href="/carshop">
